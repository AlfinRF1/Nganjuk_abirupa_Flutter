...
class _RiwayatScreenState extends State<RiwayatScreen> {
  ...
  // Pemicu refresh otomatis pas user buka via geser layar PageView
  @override
  ...
  Future<void> _loadRiwayat() async {
    ...
    try {
      ...
      var url =
          'https://nganjukabirupa.pbltifnganjuk.com/api/riwayat?id_customer=$idCustomer';
  ...
  void _filterData(String? wisata, String? status) {
    setState(() {
      _filteredList = _riwayatList.where((item) {
        ...
        bool matchWisata =
            (wisata == null || namaWisataItem.contains(wisata.toLowerCase()));
        bool matchStatus =
            (status == null || statusItem == status.toLowerCase());
              ...
              child: Row(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Image.asset(
                        'assets/images/logotextputih.png',
                        width: 100,
                      ),
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      List<String> wisataUnik = _riwayatList
                          .map((e) => e['nama_wisata'].toString())
                          .toSet()
                          .toList();
                      List<String> statusUnik = _riwayatList
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (c, i) {
                                ...
                                try {
                                  ...
                                  tglFormatted = DateFormat(
                                    'dd/MM/yyyy',
                                  ).format(dt);
                                } catch (_) {
                                  tglFormatted = item['tanggal'].toString();
                                }
                                ...
                                return GestureDetector(
                                  onTap: () => showModalBottomSheet(
                                    ...
                                    builder: (c) => DetailRiwayatBottomSheet(
                                      data: item,
                                      namaCustomer: _namaCustomer,
                                    ),
                                  ),
                                  child: Container(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () {
              widget.onApply(_wisata, _status);
